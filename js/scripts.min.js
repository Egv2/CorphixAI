!(function (e, t) {
  ...
  return (function (i) {
        ...
        var e = (function () {
          ...
          function o(e, r) {
            if (r) {
              ...
              "string" === t
                ? (function (e, t) {
                    for (var i = r.split(a), n = i.length, o = 0; o < n; ++o)
                      e[i[o]] = !0;
                  })(e)
                : Array.isArray(r)
                ? s(e, r)
    ...
    function (e, t, i) {
      ...
      (i(2).inspectSource = function (e) {
        ...
        (e.exports = function (e, t, i, n) {
          ...
          o && (s(i, "name") || l(i, "name", t)),
            e[t] !== i &&
              (o && (s(i, a) || l(i, a, e[t] ? "" + e[t] : c.join(String(t)))),
              e === r
                ? (e[t] = i)
                : n
                ? e[t]
      ...
      t.default = function () {
        ...
        Array.from(e).forEach(function (e) {
          return (function (e) {
            ...
            var r = c.default[o].toSvg(
                s({}, i, n, { class: (0, a.default)(i.class, n.class) })
              ),
              l = new DOMParser()
                .parseFromString(r, "image/svg+xml")
                .querySelector("svg");
    ...
    function (e, t, i) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      var n,
        o = (n = i(8)) && n.__esModule ? n : { default: n };
      ...
      var a = (function () {
        function n(e, t) {
          ...
          !(function (e, t) {
            ...
            (this.contents = t),
            (this.tags = i),
            (this.attrs = o({}, s.default, { class: "feather feather-" + e }));
        }
        return (
          r(n, [
            {
    ...
    function (e, t, i) {
      ...
      e.exports = { icons: n.default, toSvg: o.default, replace: r.default };
    },
    function (e, t, i) {
      var r = i(0)("iterator"),
        l = !1;
        ...
        "Array",
        {
          from: function (e) {
            var t,
              ...
              d = m(r);
            if (
              (c && (a = p(a, 2 < s ? arguments[2] : void 0, 2)),
              null == d || (l == Array && f(d)))
            )
              for (i = new l((t = v(r.length))); h < t; h++)
                g(i, h, c ? a(r[h], h) : r[h]);
            else
              for (o = d.call(r), i = new l(); !(n = o.next()).done; h++)
                g(i, h, c ? y(o, a, [n.value, h], !0) : n.value);
            return (i.length = h), i;
          },
        }
      );
    ...
    function (e, t, i) {
      ...
      e.exports = i(4)
        ...
        : function (e, t) {
            s(e);
            for (var i, n = a(t), o = n.length, r = 0; r < o; )
              l.f(e, (i = n[r++]), t[i]);
            return e;
          };
    },
    ...
    function (e, t, i) {
      ...
      i(7)(l, i(0)("iterator"), function () {
        ...
        (e.exports = function (e, t, i) {
          (e.prototype = n(l, { next: o(1, i) })), r(e, t + " Iterator");
        });
    },
    function (e, t) {
      e.exports = function (e) {
    ...
    function (e, t, i) {
      ...
      e.exports = function (e, t, i, n, o, r, l) {
        ...
        if (
          (m &&
            (c = z(m.call(new e()))) !== Object.prototype &&
            c.next &&
            (k(c, d, !0), x || "function" == typeof c[A] || M(c, A, D)),
          p &&
            f &&
            "values" !== f.name &&
            ((u = !0),
      ...
      (h = h || t || e.jQuery) &&
        (o.prototype.option ||
          (o.prototype.option = function (e) {
            h.isPlainObject(e) &&
              (this.options = h.extend(!0, this.options, e));
          }),
        (h.fn[c] = function (e) {
          if ("string" != typeof e)
            return (
  ...
  (function (e, t) {
    ...
    return function n(e) {
      if (
        ...
        for (
          var o = (i.isBorderBox = "border-box" == t.boxSizing), r = 0;
          r < b;
          r++
        ) {
          var l = x[r],
        ...
        var g = m(t.height);
        return (
          !1 !== g && (i.height = g + (f ? 0 : h + y)),
          (i.innerWidth = i.width - (c + u)),
          (i.innerHeight = i.height - (h + y)),
  ...
  (function (l, s) {
        ...
        if (((this.slides = []), this.cells.length)) {
          ...
          this.cells.forEach(function (e, t) {
            if (n.cells.length) {
              ...
              r.call(this, t, i) ||
                (n.updateTarget(), (n = new l(this)), this.slides.push(n)),
                n.addCell(e);
            } else n.addCell(e);
          }, this),
            n.updateTarget(),
    ...
    return (
      ...
      (y._containSlides = function () {
        if (
          ...
          this.slides.forEach(function (e) {
            e.target = o
              ? n * this.cellAlign
              : ((e.target = Math.max(e.target, r)), Math.min(e.target, l));
          }, this);
        }
      }),
      ...
      a && a.bridget && a.bridget("flickity", u),
    ...
    function c(e, t, i) {
      ...
      "string" == typeof e && (o = document.querySelectorAll(e)),
        o
          ...
          : l.error("Bad element for imagesLoaded " + (o || e));
    }
  ...
  (function (e, t) {
    ...
    function t() {
      ...
      p(this.store.elements, function (e) {
        ...
        p(this.store.elements, function (e) {
          -1 === o.active.indexOf(e.containerId) &&
            o.active.push(e.containerId),
    ...
    function f(e) {
      ...
      var l,
        ...
        g,
        m,
        x = parseFloat(t.opacity),
        b = isNaN(parseFloat(n.opacity))
      ...
      if (parseFloat(n.distance)) {
        ...
        switch (k[1]) {
          ...
          case "%":
            E =
              "Y" === S
                ? (e.node.getBoundingClientRect().height * z) / 100
                : (e.node.getBoundingClientRect().width * z) / 100;
            break;
          default:
            throw new RangeError("Unrecognized or missing distance unit.");
        }
        "Y" === S
          ? M.push(((a = E), ((c = O())[13] = a), c))
          : M.push(((l = E), ((s = O())[12] = l), s));
      }
      n.rotate.x &&
        M.push(
          ((h = n.rotate.x),
          (d = (Math.PI / 180) * h),
          ((p = O())[5] = p[10] = Math.cos(d)),
          (p[6] = p[9] = Math.sin(d)),
          (p[9] *= -1),
          p)
        ),
        ...
        n.rotate.z &&
          M.push(
            ((v = n.rotate.z),
            (g = (Math.PI / 180) * v),
            ((m = O())[0] = m[5] = Math.cos(g)),
            (m[1] = m[4] = Math.sin(g)),
            (m[4] *= -1),
            m)
          ),
        1 !== n.scale && (0 === n.scale ? M.push(T(2e-4)) : M.push(T(n.scale)));
      var A = {};
      if (M.length) {
        (A.property = F("transform")),
          (A.computed = {
            raw: t[A.property],
            matrix: (function (e) {
              if ("string" == typeof e) {
      ...
      if (w.generated || A.generated.initial) {
        (D.property = F("transition")),
          (D.computed = t[D.property]),
          (D.fragments = []);
        var L = n.delay,
          _ = n.duration,
          P = n.easing;
        w.generated &&
          ...
          A.generated.initial &&
            D.fragments.push({
              delayed:
                A.property + " " + _ / 1e3 + "s " + P + " " + L / 1e3 + "s",
              instant: A.property + " " + _ / 1e3 + "s " + P + " 0s",
            }),
          D.computed &&
            !D.computed.match(/all 0s/) &&
            D.fragments.unshift({ delayed: D.computed, instant: D.computed });
        var j = D.fragments.reduce(
          function (e, t, i) {
            return (
    ...
    function s(e, t) {
      var i = this,
        ...
        l = 0;
      e.callbackTimer &&
        ((l = Date.now() - e.callbackTimer.start),
    ...
    function c(e, t) {
      ...
      if (i) {
        ...
        if (((i.models = { visible: o, revealed: r }), !r.body.length)) {
          var l = i.members[o.body[0]],
            s = this.store.elements[l];
          if (s)
            return (
              m.call(this, i, o.body[0], -1, t),
              m.call(this, i, o.body[0], 1, t),
    ...
    function n(e, s, t) {
      ...
      try {
        ...
        p(
          n.reduce(function (e, t) {
            ...
            if ((!o.mobile && b()) || (!o.desktop && !b()))
              return n && y.call(a, i), e;
            var r,
              l = d(o.container)[0];
            ...
            return (
              l.contains(t) &&
                (null ===
                  ...
                  })(l, h, a.store.containers)) &&
                  ((r = v()), h.push({ id: r, node: l })),
                (i.config = o),
                (i.containerId = r),
                (i.styles = f(i)),
                c &&
                  ((i.sequence = { id: c.id, index: c.members.length }),
                  c.members.push(i.id)),
                e.push(i)),
              e
            );
      ...
      p(h, function (e) {
        ...
        !0 !== t &&
          (this.store.history.push({ target: e, options: s }),
    ...
    function z(e, t) {
      for (
        var i = t ? e.node.clientHeight : e.node.offsetHeight,
          ...
          r = 0,
          l = e.node;
        isNaN(l.offsetTop) || (o += l.offsetTop),
          isNaN(l.offsetLeft) || (r += l.offsetLeft),
          (l = l.offsetParent);

      );
      return {
        bounds: { top: o, right: r + n, bottom: o + i, left: r },
        height: i,
        width: n,
      };
    }
    ...
    function V(e) {
      ...
      if (
        (void 0 === e && (e = {}),
        void 0 === this || Object.getPrototypeOf(this) !== V.prototype)
      )
        return new V(e);
      if (!V.isSupported())
        return (
      ...
      return (!(j = t).mobile && b()) || (!j.desktop && !b())
        ? (u.call(
            this,
